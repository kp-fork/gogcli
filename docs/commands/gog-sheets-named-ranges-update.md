# `gog sheets named-ranges update`
...
```bash
gog sheets (sheet) named-ranges (namedranges,nr) update (edit,set) <spreadsheetId> <nameOrId> [flags]
```

## Parent

- [gog sheets named-ranges](gog-sheets-named-ranges.md)
