# `gog searchconsole sitemaps submit`
...
```bash
gog searchconsole (gsc,search-console,webmasters) sitemaps submit <siteUrl> <feedpath>
```

## Parent

- [gog searchconsole sitemaps](gog-searchconsole-sitemaps.md)
