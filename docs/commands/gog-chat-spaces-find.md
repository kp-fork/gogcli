...
```bash
gog chat spaces find (search,query) <displayName> [flags]
```

## Parent

- [gog chat spaces](gog-chat-spaces.md)
...
| `--exact` | `bool` |  | Require an exact, case-insensitive match on displayName instead of substring match |
