# `gog gmail labels style`

> Generated from `gog schema --json`. Do not edit this page by hand; run `make docs-commands`.

Change a user label color or visibility

## Usage

```bash
gog gmail (mail,email) labels (label) style (color,colour) <labelIdOrName> [flags]
```

## Parent

- [gog gmail labels](gog-gmail-labels.md)
...
| `--background-color` | `string` |  | Background color as #RRGGBB |
