# `gog classroom submissions grade`

> Generated from `gog schema --json`. Do not edit this page by hand; run `make docs-commands`.

Set draft/assigned grades

## Usage

```bash
gog classroom (class) submissions (submission) grade (set,edit) <courseId> <courseworkId> <submissionId> [flags]
```
