...
Move a file to trash (use --permanent to delete forever)

## Usage

```bash
gog drive (drv) delete (rm,del) <fileId> [flags]
```
...
| `--permanent` | `bool` | false | Permanently delete instead of moving to trash |
