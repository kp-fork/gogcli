...
```bash
gog classroom (class) announcements (announcement,ann) list (ls) <courseId> [flags]
```
...
| `--state` | `string` |  | Announcement states filter (comma-separated: DRAFT,PUBLISHED,DELETED) |
