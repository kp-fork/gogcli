...
Get a specific Search Console site

## Usage

```bash
gog searchconsole (gsc,search-console,webmasters) sites (list,ls) get (info,show) <siteUrl>
```

## Parent

- [gog searchconsole sites](gog-searchconsole-sites.md)
