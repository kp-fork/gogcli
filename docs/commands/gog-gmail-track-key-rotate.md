...
Rotate tracking encryption key

## Usage

```bash
gog gmail (mail,email) track key rotate [flags]
```

## Parent

- [gog gmail track key](gog-gmail-track-key.md)
...
| `--no-deploy` | `bool` |  | Update local tracking keys without deploying the Worker |
