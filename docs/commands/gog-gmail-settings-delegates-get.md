# `gog gmail settings delegates get`

> Generated from `gog schema --json`. Do not edit this page by hand; run `make docs-commands`.

Get a specific delegate's information

## Usage

```bash
gog gmail (mail,email) settings delegates get (info,show) <delegateEmail>
```

## Parent

- [gog gmail settings delegates](gog-gmail-settings-delegates.md)
