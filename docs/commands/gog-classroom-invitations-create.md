...
```bash
gog classroom (class) invitations (invitation,invites) create (add,new) --role=STRING <courseId> <userId>
```

## Parent

- [gog classroom invitations](gog-classroom-invitations.md)
...
| `--role` | `string` |  | Role: STUDENT, TEACHER, OWNER |
