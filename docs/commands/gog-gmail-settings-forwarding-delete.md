# `gog gmail settings forwarding delete`
...
```bash
gog gmail (mail,email) settings forwarding delete (rm,del,remove) <forwardingEmail>
```

## Parent

- [gog gmail settings forwarding](gog-gmail-settings-forwarding.md)
