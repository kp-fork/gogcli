# `gog config no-send remove`

> Generated from `gog schema --json`. Do not edit this page by hand; run `make docs-commands`.

Remove an account no-send guard

## Usage

```bash
gog config no-send (nosend) remove (rm,del,delete,unset,disable) <account>
```

## Parent

- [gog config no-send](gog-config-no-send.md)
