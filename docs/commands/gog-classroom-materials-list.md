...
List coursework materials

## Usage

```bash
gog classroom (class) materials (material) list (ls) <courseId> [flags]
```

## Parent

- [gog classroom materials](gog-classroom-materials.md)
...
| `--state` | `string` |  | Material states filter (comma-separated: PUBLISHED,DRAFT,DELETED) |
