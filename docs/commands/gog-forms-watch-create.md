...
```bash
gog forms (form) watch (watches) create (new,add) --topic=STRING <formId> [flags]
```

## Parent

- [gog forms watch](gog-forms-watch.md)
...
| `--event-type` | `string` | RESPONSES | Event type to watch |
