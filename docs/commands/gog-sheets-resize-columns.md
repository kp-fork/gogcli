...
```bash
gog sheets (sheet) resize-columns <spreadsheetId> <columns> [flags]
```
...
| `--auto` | `bool` |  | Auto-fit columns to content |
...
| `--width` | `int64` |  | Column width in pixels |
