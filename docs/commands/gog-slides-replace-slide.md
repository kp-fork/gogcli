...
| `--notes` | `*string` |  | New speaker notes text (omit to preserve existing notes; use --notes '' to clear) |
| `--notes-file` | `string` |  | Path to file containing new speaker notes |
